...
<div class="row">
    <div class="col-md-9">
        <div class="block-heading">
            <h4><span class="heading-icon"><i class="fa fa-th-list"></i></span>Liste des appartements en promotion</h4>
        </div>
        <div class="property-listing">
            <ul>
                @foreach($appart_promo as $appart)
    ...
    <div class="sidebar right-sidebar col-md-3">
        <form action="{{ route('search_promo') }}" method="post">
            @csrf
