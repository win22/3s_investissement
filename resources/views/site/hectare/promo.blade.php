...
<div class="row">
    <div class="col-md-9">
        <div class="block-heading">
            <h4><span class="heading-icon"><i class="fa fa-th-list"></i></span>Liste des hectares en promotion</h4>
        </div>
        <div class="property-listing">
            <ul>
                @foreach($hectare_promo as $hectare)
                <li class="type-rent col-md-12 reveal">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="property-amenities clearfix">
                            <span class="parking">Dimmension<strong>{{ $hectare->dimension }}</strong></span>
                            <span style="color: limegreen" class="parking">Reduction <strong>{{ $hectare->pourcentage }}</strong></span>
                        </div>
                </li>
                @endforeach
            </ul>
    ...
    <div class="sidebar right-sidebar col-md-3">
        <form action="{{ route('search_promo_hect') }}" method="post">
            @csrf
