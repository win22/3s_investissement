...
<div class="row">
    <div class="col-md-9">
        <div class="block-heading">
            <h4><span class="heading-icon"><i class="fa fa-th-list"></i></span>Liste des hectares à louer</h4>
        </div>
        <div class="property-listing">
            <ul>
                @foreach($hectare_louer as $hectare)
                <li class="type-rent col-md-12 reveal">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="property-amenities clearfix">
                            <span class="parking"><strong>{{ $hectare->dimension }}</strong>Dimension</span>
                        </div>
                </li>
                @endforeach
            </ul>
    ...
    <div class="sidebar right-sidebar col-md-3">
        <form action="{{ route('search_lou_hect') }}" method="post">
            @csrf
