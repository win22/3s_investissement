...
<div class="row">
    <div class="col-md-9">
        <div class="block-heading">
            <h4><span class="heading-icon"><i class="fa fa-th-list"></i></span>Liste des bureaux</h4>
        </div>
        <div class="property-listing">
            <ul>
                @foreach($bureaux as $bureau)
                <li class="type-rent col-md-12 reveal-3">
    ...
    <div class="sidebar right-sidebar col-md-3">
        <form action="{{ route('search_bur') }}" method="post">
            @csrf
