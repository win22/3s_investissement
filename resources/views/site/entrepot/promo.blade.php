...
<div class="row">
    <div class="col-md-9">
        <div class="block-heading">
            <h4><span class="heading-icon"><i class="fa fa-th-list"></i></span>Liste des entrepots en promotion</h4>
        </div>
        <div class="property-listing">
            <ul>
                @foreach($entrepot_promo as $entrepot)
                <li class="type-rent col-md-12 reveal">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="property-amenities clearfix">
                            <span class="parking">Dimmension<strong>{{ $entrepot->dimension }}</strong></span>
                            <span style="color: limegreen" class="parking">Reduction <strong>{{ $entrepot->pourcentage }}</strong></span>
                        </div>
                </li>
                @endforeach
            </ul>
        ...
        @endif
        <ul class="pagination">
            {{ $entrepot_promo->links() }}
        </ul>
    </div>
    <!-- Start Sidebar -->
    <div class="sidebar right-sidebar col-md-3">
        <form action="{{ route('search_promo_entr') }}" method="post">
            @csrf
