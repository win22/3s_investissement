...
<div class="row">
    <div class="col-md-9">
        <div class="block-heading">
            <h4><span class="heading-icon"><i class="fa fa-th-list"></i></span>Liste des entrepots à vendre</h4>
        </div>
        <div class="property-listing">
            <ul>
                @foreach($entrepot_vendre as $entrepot)
                <li class="type-rent col-md-12 reveal">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="property-amenities clearfix">
                            <span class="parking">Dimension :<strong>{{ $entrepot->dimension }}</strong></span>
                        </div>
                </li>
                @endforeach
            </ul>
    ...
    <div class="sidebar right-sidebar col-md-3">
        <form action="{{ route('search_ven_entr') }}" method="post">
            @csrf
