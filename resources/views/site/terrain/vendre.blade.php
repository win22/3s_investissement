...
<div class="row">
    <div class="col-md-9">
        <div class="block-heading">
            <h4><span class="heading-icon"><i class="fa fa-th-list"></i></span>Liste des terrains à vendre</h4>
        </div>
        <div class="property-listing">
            <ul>
                @foreach($terrain_vendre as $terrain)
    ...
    <div class="sidebar right-sidebar col-md-3">
        <form action="{{ route('search_ven_terre') }}" method="post">
            @csrf
