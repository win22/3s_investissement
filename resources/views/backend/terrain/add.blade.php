...
<div class="col-md-12 reveal">
    ...
    <div class="card card-orange card-outline">
        <div class="card-header">
            <h3 class="card-title ">Terrain</h3><br/>
            <p>Vous etes dans le formulaire d'ajout d'un terrain</p>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <div class="card-body">
            ...
            <form  action="{{ route('save_terrain') }}" enctype="multipart/form-data" method="post">
                {{ csrf_field() }}
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-6">
                            <h6  style="font-family: 'Manjari bold">Nom de du terrain<span class="text-orange"> *</span></h6>
                    ...
                    <div class="text-divider"><span>Détail du terrain</span></div>
                    <div class="row">
                        <div class="form-group col-md-6">
