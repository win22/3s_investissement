...
<div class="col-md-12 reveal">
    ...
    <div class="card card-orange card-outline">
        <div class="card-header">
            <h3 class="card-title ">entrepot</h3><br/>
            <p>Vous etes dans le formulaire d'ajout d'un entrepot</p>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <div class="card-body">
            ...
            <form  action="{{ route('save_entrepot') }}" enctype="multipart/form-data" method="post">
                {{ csrf_field() }}
                <div class="card-body">
                    <div class="row">
                    ...
                    <div class="text-divider"><span>Détail du entrepot</span></div>
                    <div class="row">
                        <div class="form-group col-md-6">
