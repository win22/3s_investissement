...
<div class="col-md-12">
    ...
    <div class="card card-orange card-outline">
        <div class="card-header">
            <h3 class="card-title badge">Magasin</h3><br/>
            <p>Vous êtes dans le formulaire de modifification d'un magasin</p>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <div class="card-body">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-6">
                            <h6  style="font-family: 'Manjari bold">Nom de la magasin<span class="text-orange"> *</span></h6>
                            <input type="text" class="form-control" value="{{ $magasin['name']}}"  name="name"  placeholder="Saisir ici">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text"  name="short_description"value="{{ $magasin['short_description']}}" class="form-control" placeholder="Saisir ici">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" value="{{ $magasin['adresse']}}" name="adresse"  placeholder="Saisir ici">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" value="{{ $magasin['ville']}}" name="ville" placeholder="Saisir ici">
                            @if($errors->has('ville'))
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" value="{{ $magasin['pays']}}" name="pays" placeholder="Saisir ici">
                            @if($errors->has('pays'))
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control" name="align">
                                ...
                                @else
                                <option class="text-orange" value="{{ $magasin['align'] }}"> {{ $magasin['align'] }} </option>
                                @endif
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input class="form-control" value="{{ $magasin['prix'] }}" placeholder="Saisi ici" name="prix">
                            @if($errors->has('prix'))
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control" name="devise" >
                                @if($magasin['devise'] == 1)
                                <option value="{{ $magasin['devise']}}">CFA</option>
                                @elseif($magasin['devise'] == 2)
                                <option value="{{ $magasin['devise']}}">EURO</option>
                                @else
                                <option value="{{ $magasin['devise']}}" >DOLLAR</option>
                                @endif
                        ...
                        <div class="form-group col-md-4 ">
                            ...
                            <select name="sold" class="form-control">
                                @if($magasin['sold'] == 1)
                                <option class="text-orange" value="{{ $magasin['sold']}}">En promo</option>
                                @else
                                <option class="text-orange" value="{{ $magasin['sold']}}" >Sans promo</option>
                                @endif
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" value="{{ $magasin['pourcentage'] }}" name="pourcentage"  placeholder="Saisir ici">
                            @if($errors->has('pourcentage'))
                            <small id="emailHelp" class="form-text text-danger">{{$errors->first('pourcentage')}}</small>
                            @endif
                        </div>
                    </div>
                    <div class="text-divider"><span>Détail de l'magasinement</span></div>
                    <div class="row">
                        <div class="form-group col-md-4">
                            <h6 style="font-family: 'Manjari Bold'" class="">Dimension</h6>
                            <input name="dimension" class="form-control" value="{{ $magasin['dimension'] }}">
