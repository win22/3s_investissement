...
<div class="col-md-12 reveal">
    ...
    <div class="card card-orange card-outline">
        <div class="card-header">
            ...
            <p>Vous etes dans le formulaire d'ajout d'un bureau</p>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <div class="card-body">
            ...
            <form  action="{{ route('save_bureau') }}" enctype="multipart/form-data" method="post">
                {{ csrf_field() }}
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-6">
                            <h6  style="font-family: 'Manjari bold">Nom de du bureau<span class="text-orange"> *</span></h6>
                    ...
                    <div class="text-divider"><span>Détail du bureau</span></div>
                    <div class="row">
                        <div class="form-group col-md-4">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input required name="piece" class="form-control" placeholder="saisir un nombre">
                            @if($errors->has('piece'))
